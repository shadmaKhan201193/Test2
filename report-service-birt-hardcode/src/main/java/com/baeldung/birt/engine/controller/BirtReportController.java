...
public class BirtReportController {
    ...
    private RestTemplate restTemplate = new RestTemplate();
	 String URL2= "http://localhost:8185/report/stock_report?output=html";
    @Autowired
	...
	{
		ResponseEntity<?>  responseFromMaster = restTemplate.exchange(URL2,HttpMethod.GET, null,String.class);

		return responseFromMaster;
